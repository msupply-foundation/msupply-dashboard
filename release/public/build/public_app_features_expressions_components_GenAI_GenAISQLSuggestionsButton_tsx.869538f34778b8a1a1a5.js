"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([["public_app_features_expressions_components_GenAI_GenAISQLSuggestionsButton_tsx"],{

/***/ "./public/app/features/expressions/components/GenAI/GenAISQLSuggestionsButton.tsx":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GenAISQLSuggestionsButton: () => (/* binding */ GenAISQLSuggestionsButton)
/* harmony export */ });
...
const getContextualPrompts = (refIds, currentQuery) => {
...
const getSQLSuggestionMessages = (refIds, currentQuery, schemas, errorContext, queryContext) => {
  const trimmedQuery = currentQuery.trim();
  const queryInstruction = trimmedQuery ? "Focus on fixing, improving, or enhancing the current query provided above." : "Generate a new SQL query based on the available RefIDs and common use cases.";
  const systemPrompt = (0,_sqlPromptConfig__WEBPACK_IMPORTED_MODULE_6__.getSQLSuggestionSystemPrompt)({
...
const GenAISQLSuggestionsButton = ({
  currentQuery,
  onGenerate,
  onHistoryUpdate,
  refIds,
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
    _dashboard_components_GenAI_GenAIButton__WEBPACK_IMPORTED_MODULE_3__.GenAIButton,
    {
      ...
      temperature: 0.3,
      text: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.t)("sql-expressions.sql-ai-interaction", `{{text}}`, { text }),
      timeout: 6e4,
      toggleTipTitle: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.t)("sql-expressions.ai-suggestions-title", "AI-powered SQL expression suggestions"),
      tooltip: refIds.length === 0 ? (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.t)("sql-expressions.add-query-tooltip", "Add at least one data query to generate SQL suggestions") : (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.t)(
...
//# sourceMappingURL=public_app_features_expressions_components_GenAI_GenAISQLSuggestionsButton_tsx.869538f34778b8a1a1a5.js.map