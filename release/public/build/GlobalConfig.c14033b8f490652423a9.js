"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([["GlobalConfig"],{
...
/* harmony import */ var _hooks_useAlertmanagerConfig__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./public/app/features/alerting/unified/hooks/useAlertmanagerConfig.ts");
/* harmony import */ var _state_AlertmanagerContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./public/app/features/alerting/unified/state/AlertmanagerContext.tsx");
...
/* harmony import */ var _AlertingPageWrapper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./public/app/features/alerting/unified/components/AlertingPageWrapper.tsx");
/* harmony import */ var _receivers_GlobalConfigForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./public/app/features/alerting/unified/components/receivers/GlobalConfigForm.tsx");
...
const GlobalConfig = () => {
  const { selectedAlertmanager } = (0,_state_AlertmanagerContext__WEBPACK_IMPORTED_MODULE_4__.useAlertmanager)();
  const { data, isLoading, error } = (0,_hooks_useAlertmanagerConfig__WEBPACK_IMPORTED_MODULE_3__.useAlertmanagerConfig)(selectedAlertmanager);
  if (isLoading && !data) {
    return "loading...";
  }
  if (error) {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_receivers_GlobalConfigForm__WEBPACK_IMPORTED_MODULE_7__.GlobalConfigForm, { config: data, alertManagerSourceName: selectedAlertmanager });
};
function GlobalConfigPage() {
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_AlertingPageWrapper__WEBPACK_IMPORTED_MODULE_6__.AlertmanagerPageWrapper, { navId: "receivers", accessType: "notification", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(GlobalConfig, {}) });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_withPageErrorBoundary__WEBPACK_IMPORTED_MODULE_5__.withPageErrorBoundary)(GlobalConfigPage));
...
/* harmony import */ var _utils_cloud_alertmanager_notifier_types__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./public/app/features/alerting/unified/utils/cloud-alertmanager-notifier-types.ts");
...
/* harmony import */ var _utils_receiver_form__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./public/app/features/alerting/unified/utils/receiver-form.ts");
/* harmony import */ var _utils_redux__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./public/app/features/alerting/unified/utils/redux.ts");
/* harmony import */ var _form_fields_OptionField__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./public/app/features/alerting/unified/components/receivers/form/fields/OptionField.tsx");
...
const GlobalConfigForm = ({ config, alertManagerSourceName }) => {
  const dispatch = (0,app_types_store__WEBPACK_IMPORTED_MODULE_7__.useDispatch)();
  (0,app_core_hooks_useCleanup__WEBPACK_IMPORTED_MODULE_6__.useCleanup)((state) => state.unifiedAlerting.saveAMConfig = _utils_redux__WEBPACK_IMPORTED_MODULE_14__.initialAsyncRequestState);
  const { loading, error } = (0,_hooks_useUnifiedAlertingSelector__WEBPACK_IMPORTED_MODULE_8__.useUnifiedAlertingSelector)((state) => state.saveAMConfig);
  const readOnly = (0,_utils_datasource__WEBPACK_IMPORTED_MODULE_11__.isVanillaPrometheusAlertManagerDataSource)(alertManagerSourceName);
  const formAPI = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_1__.useForm)({
  ...
  const onSubmitCallback = (values) => {
    dispatch(
      (0,_state_actions__WEBPACK_IMPORTED_MODULE_9__.updateAlertManagerConfigAction)({
        newConfig: {
          ...config,
          alertmanager_config: {
            ...config.alertmanager_config,
            global: (0,_utils_receiver_form__WEBPACK_IMPORTED_MODULE_13__.omitEmptyValues)(values)
          }
        },
        oldConfig: config,
        alertManagerSourceName,
        successMessage: "Global config updated.",
        redirectPath: (0,_utils_misc__WEBPACK_IMPORTED_MODULE_12__.makeAMLink)("/alerting/notifications", alertManagerSourceName)
      })
    );
  };
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_hook_form__WEBPACK_IMPORTED_MODULE_1__.FormProvider, { ...formAPI, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", { onSubmit: handleSubmit(onSubmitCallback), children: [
    error && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      _grafana_ui__WEBPACK_IMPORTED_MODULE_3__.Alert,
      {
        severity: "error",
        title: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.t)("alerting.global-config-form.title-error-saving-receiver", "Error saving receiver"),
        children: error.message || String(error)
      }
    ),
    _utils_cloud_alertmanager_notifier_types__WEBPACK_IMPORTED_MODULE_10__.globalConfigOptions.map((option) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      _form_fields_OptionField__WEBPACK_IMPORTED_MODULE_15__.OptionField,
      {
        readOnly,
    ...
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__.Stack, { children: [
      !readOnly && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [
        loading && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__.Button, { disabled: true, icon: "spinner", variant: "primary", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.Trans, { i18nKey: "alerting.global-config-form.saving", children: "Saving..." }) }),
        !loading && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__.Button, { type: "submit", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.Trans, { i18nKey: "alerting.global-config-form.save-global-config", children: "Save global config" }) })
      ] }),
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        _grafana_ui__WEBPACK_IMPORTED_MODULE_4__.LinkButton,
        {
          ...
          fill: "outline",
          variant: "secondary",
          href: (0,_utils_misc__WEBPACK_IMPORTED_MODULE_12__.makeAMLink)("alerting/notifications", alertManagerSourceName),
          children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_2__.Trans, { i18nKey: "alerting.common.cancel", children: "Cancel" })
        }
      )
    ] }) })
  ] }) });
...
//# sourceMappingURL=GlobalConfig.c14033b8f490652423a9.js.map