...
/* harmony import */ var app_core_components_RolePicker_hooks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./public/app/core/components/RolePicker/hooks.ts");
/* harmony import */ var app_core_core__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./public/app/core/core.ts");
...
const CreateTeam = () => {
  const currentOrgId = app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.user.orgId;
  const [pendingRoles, setPendingRoles] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [{ roleOptions }] = (0,app_core_components_RolePicker_hooks__WEBPACK_IMPORTED_MODULE_14__.useRoleOptions)(currentOrgId);
  const {
    handleSubmit,
    register,
    formState: { errors }
  } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_2__.useForm)();
  const canUpdateRoles = app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.hasPermission(app_types_accessControl__WEBPACK_IMPORTED_MODULE_16__.AccessControlAction.ActionUserRolesAdd) && app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.hasPermission(app_types_accessControl__WEBPACK_IMPORTED_MODULE_16__.AccessControlAction.ActionUserRolesRemove);
  const createTeam = async (formModel) => {
    try {
      const newTeam = await (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__.getBackendSrv)().post("/api/teams", formModel);
      if (newTeam.teamId) {
        await app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.fetchUserPermissions();
        if (app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.licensedAccessControlEnabled() && canUpdateRoles) {
          await (0,app_core_components_RolePicker_api__WEBPACK_IMPORTED_MODULE_13__.updateTeamRoles)(pendingRoles, newTeam.teamId, newTeam.orgId);
        }
        _grafana_runtime__WEBPACK_IMPORTED_MODULE_5__.locationService.push(`/org/teams/edit/${newTeam.uid}`);
      }
    } catch (e) {
      console.error(e);
    }
  };
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(app_core_components_Page_Page__WEBPACK_IMPORTED_MODULE_11__.Page, { navId: "teams", pageNav, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(app_core_components_Page_Page__WEBPACK_IMPORTED_MODULE_11__.Page.Contents, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", { onSubmit: handleSubmit(createTeam), style: { maxWidth: "600px" }, children: [
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_9__.FieldSet, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_grafana_ui__WEBPACK_IMPORTED_MODULE_7__.Stack, { direction: "column", gap: 2, children: [
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        _grafana_ui__WEBPACK_IMPORTED_MODULE_8__.Field,
        {
          noMargin: true,
          label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_3__.t)("teams.create-team.label-name", "Name"),
          required: true,
          invalid: !!errors.name,
          error: "Team name is required",
          children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_10__.Input, { ...register("name", { required: true }), id: "team-name" })
        }
      ),
      app_core_core__WEBPACK_IMPORTED_MODULE_15__.contextSrv.licensedAccessControlEnabled() && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_8__.Field, { noMargin: true, label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_3__.t)("teams.create-team.label-role", "Role"), children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        app_core_components_RolePicker_TeamRolePicker__WEBPACK_IMPORTED_MODULE_12__.TeamRolePicker,
        {
          teamId: 0,
          roleOptions,
          disabled: false,
      ...
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        ...
        {
          noMargin: true,
          label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_3__.t)("teams.create-team.label-email", "Email"),
          ...
          children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_10__.Input, { ...register("email"), type: "email", id: "team-email", placeholder: "email@test.com" })
        }
      )
    ] }) }),
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_6__.Button, { type: "submit", variant: "primary", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_3__.Trans, { i18nKey: "teams.create-team.create", children: "Create" }) })
  ] }) }) });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CreateTeam);


/***/ })

}]);
//# sourceMappingURL=CreateTeam.511c3de29ef0102c3393.js.map