"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([["stateTimelinePanel"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   StateTimelinePanel: () => (/* binding */ StateTimelinePanel)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./packages/grafana-ui/src/components/uPlot/plugins/EventBusPlugin.tsx");
...
/* harmony import */ var app_core_components_TimelineChart_TimelineChart__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./public/app/core/components/TimelineChart/TimelineChart.tsx");
...
/* harmony import */ var _timeseries_plugins_AnnotationsPlugin2__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./public/app/plugins/panel/timeseries/plugins/AnnotationsPlugin2.tsx");
/* harmony import */ var _timeseries_plugins_OutsideRangePlugin__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./public/app/plugins/panel/timeseries/plugins/OutsideRangePlugin.tsx");
/* harmony import */ var _timeseries_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./public/app/plugins/panel/timeseries/utils.ts");
/* harmony import */ var _StateTimelineTooltip__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./public/app/plugins/panel/state-timeline/StateTimelineTooltip.tsx");
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./public/app/plugins/panel/state-timeline/hooks.tsx");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./public/app/plugins/panel/state-timeline/styles.ts");
...
const StateTimelinePanel = ({
  ...
  const { sync, eventsScope, canAddAnnotations, eventBus, canExecuteActions } = (0,_grafana_ui__WEBPACK_IMPORTED_MODULE_6__.usePanelContext)();
  ...
  const { frames, warn } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(
    () => (0,app_core_components_TimelineChart_utils__WEBPACK_IMPORTED_MODULE_11__.prepareTimelineFields)(data.series, options.mergeValues ?? true, timeRange, theme),
    [data.series, options.mergeValues, timeRange, theme]
  );
  const { paginatedFrames, paginationRev, paginationElement, paginationHeight } = (0,_hooks__WEBPACK_IMPORTED_MODULE_16__.usePagination)(
    frames,
    options.perPage
  );
  const legendItems = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(
    () => (0,app_core_components_TimelineChart_utils__WEBPACK_IMPORTED_MODULE_11__.prepareTimelineLegendItems)(paginatedFrames, options.legend, theme),
    [paginatedFrames, options.legend, theme]
  );
  const timezones = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => (0,_timeseries_utils__WEBPACK_IMPORTED_MODULE_14__.getTimezones)(options.timezone, timeZone), [options.timezone, timeZone]);
  if (!paginatedFrames || typeof warn === "string") {
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__.PanelDataErrorView, { panelId, fieldConfig, data, message: warn, needsTimeField: true });
  }
  const enableAnnotationCreation = Boolean(canAddAnnotations && canAddAnnotations());
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: _styles__WEBPACK_IMPORTED_MODULE_17__.containerStyles, children: [
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      app_core_components_TimelineChart_TimelineChart__WEBPACK_IMPORTED_MODULE_10__.TimelineChart,
      {
        theme,
        ...
        legendItems,
        ...options,
        mode: app_core_components_TimelineChart_utils__WEBPACK_IMPORTED_MODULE_11__.TimelineMode.Changes,
        replaceVariables,
        dataLinkPostProcessor,
        cursorSync,
        children: (builder, alignedFrame) => {
          return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [
            cursorSync !== _grafana_data__WEBPACK_IMPORTED_MODULE_3__.DashboardCursorSync.Off && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_8__.EventBusPlugin, { config: builder, eventBus, frame: alignedFrame }),
            options.tooltip.mode !== _grafana_ui__WEBPACK_IMPORTED_MODULE_5__.TooltipDisplayMode.None && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
              _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.TooltipPlugin2,
              {
                config: builder,
                hoverMode: options.tooltip.mode === _grafana_ui__WEBPACK_IMPORTED_MODULE_5__.TooltipDisplayMode.Multi ? _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.TooltipHoverMode.xAll : _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.TooltipHoverMode.xOne,
                ...
                render: (u, dataIdxs, seriesIdx, isPinned, dismiss, timeRange2, viaSync, dataLinks) => {
                  ...
                  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    _StateTimelineTooltip__WEBPACK_IMPORTED_MODULE_15__.StateTimelineTooltip,
                    {
                      series: alignedFrame,
                      dataIdxs,
                      seriesIdx,
                      mode: viaSync ? _grafana_ui__WEBPACK_IMPORTED_MODULE_5__.TooltipDisplayMode.Multi : options.tooltip.mode,
            ...
            alignedFrame.fields[0].config.custom?.axisPlacement !== _grafana_ui__WEBPACK_IMPORTED_MODULE_5__.AxisPlacement.Hidden && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
              _timeseries_plugins_AnnotationsPlugin2__WEBPACK_IMPORTED_MODULE_12__.AnnotationsPlugin2,
              {
                replaceVariables,
            ...
            /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_timeseries_plugins_OutsideRangePlugin__WEBPACK_IMPORTED_MODULE_13__.OutsideRangePlugin, { config: builder, onChangeTimeRange })
          ] });
        }
      }
    ),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   timelinePanelChangedHandler: () => (/* binding */ timelinePanelChangedHandler)
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./packages/grafana-data/src/types/valueMapping.ts");



const timelinePanelChangedHandler = (panel, prevPluginId, prevOptions) => {
  ...
  if (prevPluginId === "natel-discrete-panel" && prevOptions.angular) {
    ...
    const valuemap = { type: _grafana_data__WEBPACK_IMPORTED_MODULE_1__.MappingType.ValueToText, options: {} };
    fieldConfig.defaults.mappings = [valuemap];
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isArray)(oldOptions.colorMaps)) {
    ...
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isArray)(oldOptions.valueMaps)) {
    ...
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isArray)(oldOptions.rangeMaps)) {
      for (const p of oldOptions.rangeMaps) {
        ...
        if (text) {
          fieldConfig.defaults.mappings.push({
            type: _grafana_data__WEBPACK_IMPORTED_MODULE_1__.MappingType.RangeToText,
            options: {
              from,
              to,
              result: { text }
...
function expandColorMappings(mappings) {
  let keyToColor = {};
...
function isValueToText(m) {
  return m.type === _grafana_data__WEBPACK_IMPORTED_MODULE_1__.MappingType.ValueToText;
}
function isRangeMap(m) {
  return m.type === _grafana_data__WEBPACK_IMPORTED_MODULE_1__.MappingType.RangeToText;
}
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./packages/grafana-ui/src/options/builder/legend.tsx");
...
/* harmony import */ var _timeseries_InsertNullsEditor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./public/app/plugins/panel/timeseries/InsertNullsEditor.tsx");
/* harmony import */ var _timeseries_SpanNullsEditor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./public/app/plugins/panel/timeseries/SpanNullsEditor.tsx");
/* harmony import */ var _StateTimelinePanel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./public/app/plugins/panel/state-timeline/StateTimelinePanel.tsx");
/* harmony import */ var _migrations__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./public/app/plugins/panel/state-timeline/migrations.ts");
/* harmony import */ var _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./public/app/plugins/panel/state-timeline/panelcfg.gen.ts");
/* harmony import */ var _suggestions__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./public/app/plugins/panel/state-timeline/suggestions.ts");
...
const plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_1__.PanelPlugin(_StateTimelinePanel__WEBPACK_IMPORTED_MODULE_13__.StateTimelinePanel).setPanelChangeHandler(_migrations__WEBPACK_IMPORTED_MODULE_14__.timelinePanelChangedHandler).useFieldConfig({
  standardOptions: {
    [_grafana_data__WEBPACK_IMPORTED_MODULE_3__.FieldConfigProperty.Color]: {
      settings: {
        byValueSupport: true
      },
      defaultValue: {
        mode: _grafana_data__WEBPACK_IMPORTED_MODULE_2__.FieldColorModeId.ContinuousGrYlRd
      }
    },
    [_grafana_data__WEBPACK_IMPORTED_MODULE_3__.FieldConfigProperty.Links]: {
      settings: {
        showOneClick: true
      }
    },
  ...
  useCustomConfig: (builder) => {
    const category = [(0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.category-state-timeline", "State timeline")];
    builder.addSliderInput({
      path: "lineWidth",
      name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-line-width", "Line width"),
      category,
      defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultFieldConfig.lineWidth,
      settings: {
        min: 0,
        max: 10,
        step: 1
      ...
      path: "fillOpacity",
      name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-fill-opacity", "Fill opacity"),
      category,
      defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultFieldConfig.fillOpacity,
      settings: {
        min: 0,
        max: 100,
        step: 1
      ...
      id: "spanNulls",
      path: "spanNulls",
      name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-connect-null-values", "Connect null values"),
      category,
      defaultValue: false,
      editor: _timeseries_SpanNullsEditor__WEBPACK_IMPORTED_MODULE_12__.SpanNullsEditor,
      override: _timeseries_SpanNullsEditor__WEBPACK_IMPORTED_MODULE_12__.SpanNullsEditor,
      shouldApply: (field) => field.type !== _grafana_data__WEBPACK_IMPORTED_MODULE_4__.FieldType.time,
      process: _grafana_data__WEBPACK_IMPORTED_MODULE_0__.identityOverrideProcessor,
      settings: { isTime: true }
    }).addCustomEditor({
      id: "insertNulls",
      path: "insertNulls",
      name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-disconnect-values", "Disconnect values"),
      category,
      defaultValue: false,
      editor: _timeseries_InsertNullsEditor__WEBPACK_IMPORTED_MODULE_11__.InsertNullsEditor,
      override: _timeseries_InsertNullsEditor__WEBPACK_IMPORTED_MODULE_11__.InsertNullsEditor,
      shouldApply: (field) => field.type !== _grafana_data__WEBPACK_IMPORTED_MODULE_4__.FieldType.time,
      process: _grafana_data__WEBPACK_IMPORTED_MODULE_0__.identityOverrideProcessor,
      settings: { isTime: true }
    });
    _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.addHideFrom(builder);
    _grafana_ui__WEBPACK_IMPORTED_MODULE_8__.addAxisPlacement(
      builder,
      (placement) => placement === _grafana_schema__WEBPACK_IMPORTED_MODULE_6__.AxisPlacement.Auto || placement === _grafana_schema__WEBPACK_IMPORTED_MODULE_6__.AxisPlacement.Hidden
    );
    _grafana_ui__WEBPACK_IMPORTED_MODULE_8__.addAxisWidth(builder);
  }
}).setPanelOptions((builder) => {
  const category = [(0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.category-state-timeline", "State timeline")];
  builder.addBooleanSwitch({
    path: "mergeValues",
    name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-merge-equal-consecutive-values", "Merge equal consecutive values"),
    category,
    defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultOptions.mergeValues
  }).addRadio({
    path: "showValue",
    name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-show-values", "Show values"),
    category,
    settings: {
      options: [
        { value: _grafana_schema__WEBPACK_IMPORTED_MODULE_6__.VisibilityMode.Auto, label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.show-values-options.label-auto", "Auto") },
        { value: _grafana_schema__WEBPACK_IMPORTED_MODULE_6__.VisibilityMode.Always, label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.show-values-options.label-always", "Always") },
        { value: _grafana_schema__WEBPACK_IMPORTED_MODULE_6__.VisibilityMode.Never, label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.show-values-options.label-never", "Never") }
      ]
    },
    defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultOptions.showValue
  }).addRadio({
    path: "alignValue",
    name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-align-values", "Align values"),
    category,
    settings: {
      options: [
        { value: "left", label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.align-values-options.label-left", "Left") },
        { value: "center", label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.align-values-options.label-center", "Center") },
        { value: "right", label: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.align-values-options.label-right", "Right") }
      ]
    },
    defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultOptions.alignValue
  }).addSliderInput({
    path: "rowHeight",
    name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-row-height", "Row height"),
    category,
    settings: {
      min: 0,
      max: 1,
    ...
    defaultValue: _panelcfg_gen__WEBPACK_IMPORTED_MODULE_15__.defaultOptions.rowHeight
  }).addNumberInput({
    path: "perPage",
    name: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_5__.t)("state-timeline.name-page-size", "Page size (enable pagination)"),
    category,
    settings: {
      min: 1,
      step: 1,
  ...
  _grafana_ui__WEBPACK_IMPORTED_MODULE_9__.addLegendOptions(builder, false);
  _grafana_ui__WEBPACK_IMPORTED_MODULE_10__.addTooltipOptions(builder);
}).setSuggestionsSupplier(new _suggestions__WEBPACK_IMPORTED_MODULE_16__.StatTimelineSuggestionsSupplier()).setDataSupport({ annotations: true });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   StatTimelineSuggestionsSupplier: () => (/* binding */ StatTimelineSuggestionsSupplier)
/* harmony export */ });
/* harmony import */ var app_types_suggestions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./public/app/types/suggestions.ts");


class StatTimelineSuggestionsSupplier {
  getSuggestionsForData(builder) {
    ...
    list.append({ name: app_types_suggestions__WEBPACK_IMPORTED_MODULE_0__.SuggestionName.StateTimeline });
  }
}
...
//# sourceMappingURL=stateTimelinePanel.7eb04e7d7e2d31591e67.js.map