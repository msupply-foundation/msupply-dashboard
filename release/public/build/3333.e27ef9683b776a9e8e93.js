...
`,Oe=["children","className"],Me=["children","className","width","style"];function Re(e,t){if(null==e)return{};var n,r,s={},a=Object.keys(e);for(r=0;r<a.length;r++)n=a[r],t.indexOf(n)>=0||(s[n]=e[n]);return s}const ze=M((()=>({flexRow:m`
    ...
    `,LabeledListLabel:m`
      ...
      color: ${C(e)?"#999":"#666"};
      margin-right: 0.25rem;
    `})));function Jn(e){var t;const{className:n,dividerClassName:r,items:s}=e,a=Xn(O());return(0,k.jsx)("ul",{className:f()(a.LabeledList,n),children:s.map((({key:e,label:n,value:o},i)=>{const l=i<s.length-1&&(0,k.jsx)("li",{className:a.LabeledListItem,children:t||(t=(0,k.jsx)(ut,{className:r,type:"vertical"}))},`${e}--divider`);return[(0,k.jsxs)("li",{className:a.LabeledListItem,children:[(0,k.jsx)("span",{className:a.LabeledListLabel,children:n}),(0,k.jsx)("strong",{children:o})]},e),l]}))})}var Yn,Qn;const er=M((()=>({ReferencesList:m`
      background: #fff;
    ...
    `})));function qr({isDragging:e,onMouseDown:t,onMouseEnter:n,onMouseLeave:r,position:s}){const a=100*s+"%",o=Kr(),i=f()({[o.ScrubberDragging]:e});return(0,k.jsxs)("g",{className:i,children:[(0,k.jsxs)("g",{className:o.ScrubberHandles,onMouseDown:t,onMouseEnter:n,onMouseLeave:r,children:[(0,k.jsx)("rect",{x:a,className:o.ScrubberHandleExpansion,style:{transform:"translate(-4.5px)"},width:"9",height:"20"}),(0,k.jsx)("rect",{x:a,className:o.ScrubberHandle,style:{transform:"translate(-1.5px)"},width:"3",height:"20"})]}),(0,k.jsx)("line",{className:o.ScrubberLine,y2:"100%",x1:a,x2:a})]})}function Zr(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Xr=M((e=>{const t="JaegerUiComponents__ViewingLayerResetZoomHoverClassName",n=m`
