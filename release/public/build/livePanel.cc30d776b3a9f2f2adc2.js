"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([["livePanel"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   discoveryResources: () => (/* binding */ discoveryResources),
/* harmony export */   getAPIGroupDiscoveryList: () => (/* binding */ getAPIGroupDiscoveryList)
/* harmony export */ });
...
async function getAPIGroupDiscoveryList() {
  return await (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.lastValueFrom)(
...
function discoveryResources(apis) {
  const resources = [];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LiveChannelEditor: () => (/* binding */ LiveChannelEditor)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/jsx-runtime.js");
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/@emotion/css/dist/emotion-css.development.esm.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./packages/grafana-data/src/types/live.ts");
/* harmony import */ var _grafana_i18n__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./packages/grafana-i18n/src/i18n.tsx");
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./packages/grafana-ui/src/components/Combobox/Combobox.tsx");
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./packages/grafana-ui/src/themes/stylesFactory.ts");
/* harmony import */ var app_core_config__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./public/app/core/config.ts");
/* harmony import */ var app_features_apiserver_discovery__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./public/app/features/apiserver/discovery.ts");
/* harmony import */ var app_features_live_info__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("./public/app/features/live/info.ts");
...
const scopes = [
  { label: "Grafana", value: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Grafana, description: "Core grafana live features" },
  { label: "Data Sources", value: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.DataSource, description: "Data sources with live support" },
  { label: "Plugins", value: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Plugin, description: "Plugins with live support" },
  { label: "Stream", value: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Stream, description: "data streams (eg, influx style)" },
  { label: "Watch", value: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Watch, description: "Watch k8s style resources" }
];
function LiveChannelEditor(props) {
  const [channels, setChannels] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [namespaces, paths] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
    const namespaces2 = [];
    const paths2 = [];
    const scope2 = props.value.scope;
    const namespace2 = props.value.namespace;
    if (!scope2?.length) {
      return [namespaces2, paths2];
    }
    const used = {};
    for (let channel of channels) {
      const addr = (0,_grafana_data__WEBPACK_IMPORTED_MODULE_3__.parseLiveChannelAddress)(channel.value);
      if (!addr || addr.scope !== scope2) {
        continue;
      }
      ...
      if (namespace2?.length && namespace2 === addr.namespace) {
        paths2.push({
          ...channel,
          value: addr.path
        });
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    (0,app_features_live_info__WEBPACK_IMPORTED_MODULE_12__.getManagedChannelInfo)().then((v) => {
      setChannels(v.channels);
    });
  }, [props.value.scope]);
  const onScopeChanged = (v) => {
    if (v.value) {
      props.onChange({
        scope: v.value,
        namespace: void 0,
  ...
  const getWatchableResources = async (v) => {
    const apis = await (0,app_features_apiserver_discovery__WEBPACK_IMPORTED_MODULE_11__.getAPIGroupDiscoveryList)();
    return (0,app_features_apiserver_discovery__WEBPACK_IMPORTED_MODULE_11__.discoveryResources)(apis).filter((v2) => v2.verbs.includes("watch")).map((r) => ({
      value: `${r.responseKind.group}/${r.responseKind.version}/${r.resource}`,
      // must be string | number
      resource: r
    }));
  };
  const { scope, namespace, path } = props.value;
  const style = getStyles(app_core_config__WEBPACK_IMPORTED_MODULE_10__.config.theme2);
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__.Alert, { title: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_4__.t)("live.live-channel-editor.title-grafana-live", "Grafana Live"), severity: "info", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_4__.Trans, { i18nKey: "live.live-channel-editor.description-grafana-live", children: "This supports real-time event streams in Grafana core. This feature is under heavy development. Expect the interfaces and structures to change as this becomes more production ready." }) }),
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { children: [
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: style.dropWrap, children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_6__.Label, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_4__.Trans, { i18nKey: "live.live-channel-editor.scope", children: "Scope" }) }),
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_7__.Select, { options: scopes, value: scopes.find((s) => s.value === scope), onChange: onScopeChanged })
      ] }),
      scope === _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Watch && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: style.dropWrap, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        _grafana_ui__WEBPACK_IMPORTED_MODULE_8__.Combobox,
        {
          ...
          onChange: (v) => {
            ...
            if (resource) {
              props.onChange({
                scope: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LiveChannelScope.Watch,
                namespace: resource.responseKind.group,
                path: `${resource.responseKind.version}/${resource.resource}/${app_core_config__WEBPACK_IMPORTED_MODULE_10__.config.bootData.user.uid}`
      ...
      scope && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: style.dropWrap, children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_6__.Label, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_4__.Trans, { i18nKey: "live.live-channel-editor.namespace", children: "Namespace" }) }),
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
          _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.Select,
          {
            options: namespaces,
            value: namespaces.find((s) => s.value === namespace) ?? (namespace ? { label: namespace, value: namespace } : void 0),
      ...
      scope && namespace && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { className: style.dropWrap, children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_6__.Label, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_4__.Trans, { i18nKey: "live.live-channel-editor.path", children: "Path" }) }),
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
          _grafana_ui__WEBPACK_IMPORTED_MODULE_7__.Select,
          {
            options: paths,
...
const getStyles = (0,_grafana_ui__WEBPACK_IMPORTED_MODULE_9__.stylesFactory)((theme) => ({
  dropWrap: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LivePanel: () => (/* binding */ LivePanel)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/jsx-runtime.js");
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/@emotion/css/dist/emotion-css.development.esm.js");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./packages/grafana-data/src/dataframe/StreamingDataFrame.ts");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./packages/grafana-data/src/field/fieldOverrides.ts");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./packages/grafana-data/src/types/live.ts");
...
/* harmony import */ var _grafana_runtime__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("./packages/grafana-runtime/src/services/live.ts");
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("./packages/grafana-ui/src/components/CustomScrollbar/CustomScrollbar.tsx");
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("./packages/grafana-ui/src/components/JSONFormatter/JSONFormatter.tsx");
...
/* harmony import */ var _table_TablePanel__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./public/app/plugins/panel/table/TablePanel.tsx");
/* harmony import */ var _LivePublish__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./public/app/plugins/panel/live/LivePublish.tsx");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./public/app/plugins/panel/live/types.ts");
...
class LivePanel extends react__WEBPACK_IMPORTED_MODULE_3__.PureComponent {
  constructor(props) {
    super(props);
    this.styles = getStyles(_grafana_runtime__WEBPACK_IMPORTED_MODULE_9__.config.theme2);
    this.streamObserver = {
      next: (event) => {
        if ((0,_grafana_data__WEBPACK_IMPORTED_MODULE_6__.isLiveChannelStatusEvent)(event)) {
          this.setState({ status: event, changed: Date.now() });
        } else if ((0,_grafana_data__WEBPACK_IMPORTED_MODULE_6__.isLiveChannelMessageEvent)(event)) {
    ...
    this.isValid = !!(0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_10__.getGrafanaLiveSrv)();
  ...
  async loadChannel() {
    ...
    if (!(0,_grafana_data__WEBPACK_IMPORTED_MODULE_6__.isValidLiveChannelAddress)(addr)) {
    ...
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_2__.isEqual)(addr, this.state.addr)) {
      console.log("Same channel", this.state.addr);
      return;
    }
    const live = (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_10__.getGrafanaLiveSrv)();
    if (!live) {
      console.log("INVALID", addr);
      this.unsubscribe();
      this.setState({
    ...
    try {
      ...
      this.setState({ addr, error: void 0 });
    } catch (err) {
      this.setState({ addr: void 0, error: err });
    }
  }
  renderNotEnabled() {
    const preformatted = `[feature_toggles]
    enable = live`;
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_grafana_ui__WEBPACK_IMPORTED_MODULE_12__.Alert, { title: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.t)("live.live-panel.title-grafana-live", "Grafana Live"), severity: "info", children: [
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.Trans, { i18nKey: "live.live-panel.grafana-requires-feature", children: "Grafana live requires a feature flag to run" }) }),
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("b", { children: "custom.ini:" }),
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("pre", { children: preformatted })
    ] });
  }
  renderMessage(height) {
    ...
    if (!message) {
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h4", { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.Trans, { i18nKey: "live.live-panel.waiting-for-data", children: "Waiting for data:" }) }),
        options.channel?.scope,
        "/",
        options.channel?.namespace,
        "/",
        options.channel?.path
      ] });
    }
    if (options.display === _types__WEBPACK_IMPORTED_MODULE_17__.MessageDisplayMode.JSON) {
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_13__.JSONFormatter, { json: message, open: 5 });
    }
    if (options.display === _types__WEBPACK_IMPORTED_MODULE_17__.MessageDisplayMode.Auto) {
      if (message instanceof _grafana_data__WEBPACK_IMPORTED_MODULE_4__.StreamingDataFrame) {
        const data = {
          series: (0,_grafana_data__WEBPACK_IMPORTED_MODULE_5__.applyFieldOverrides)({
            data: [message],
            theme: _grafana_runtime__WEBPACK_IMPORTED_MODULE_9__.config.theme2,
          ...
          state: _grafana_data__WEBPACK_IMPORTED_MODULE_7__.LoadingState.Streaming
        };
        const props = {
          ...this.props,
          options: { frameIndex: 0, showHeader: true }
        };
        return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_table_TablePanel__WEBPACK_IMPORTED_MODULE_15__.TablePanel, { ...props, data, height });
      }
    }
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("pre", { children: JSON.stringify(message) });
  }
  renderPublish(height) {
    const { options } = this.props;
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      _LivePublish__WEBPACK_IMPORTED_MODULE_16__.LivePublish,
      {
        height,
        body: options.message,
        mode: options.publish ?? _types__WEBPACK_IMPORTED_MODULE_17__.MessagePublishMode.JSON,
  ...
  renderStatus() {
    ...
    if (status?.state === _grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Connected) {
      return;
    }
    let statusClass = "";
    if (status) {
    ...
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.cx)(statusClass, this.styles.statusWrap), children: status?.state });
  }
  renderBody() {
    const { status } = this.state;
    const { options, height } = this.props;
    const publish = options.publish === _types__WEBPACK_IMPORTED_MODULE_17__.MessagePublishMode.JSON || options.publish === _types__WEBPACK_IMPORTED_MODULE_17__.MessagePublishMode.Influx;
    if (publish) {
      if (options.display === _types__WEBPACK_IMPORTED_MODULE_17__.MessageDisplayMode.None) {
        return this.renderPublish(height);
      }
      const halfHeight = height / 2;
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { height: halfHeight, overflow: "hidden" }, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_11__.CustomScrollbar, { autoHeightMin: "100%", autoHeightMax: "100%", children: this.renderMessage(halfHeight) }) }),
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { children: this.renderPublish(halfHeight) })
      ] });
    }
    if (options.display === _types__WEBPACK_IMPORTED_MODULE_17__.MessageDisplayMode.None) {
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("pre", { children: JSON.stringify(status) });
    }
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { overflow: "hidden", height }, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_11__.CustomScrollbar, { autoHeightMin: "100%", autoHeightMax: "100%", children: this.renderMessage(height) }) });
  }
  render() {
    if (!this.isValid) {
    ...
    if (!addr) {
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_12__.Alert, { title: (0,_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.t)("live.live-panel.title-grafana-live", "Grafana Live"), severity: "info", children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.Trans, { i18nKey: "live.live-panel.panel-editor-channel", children: "Use the panel editor to pick a channel" }) });
    }
    if (error) {
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { children: [
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h2", { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_8__.Trans, { i18nKey: "live.live-panel.error", children: "Error" }) }),
        /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { children: JSON.stringify(error) })
      ] });
    }
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [
      this.renderStatus(),
...
const getStyles = (0,_grafana_ui__WEBPACK_IMPORTED_MODULE_14__.stylesFactory)((theme) => ({
  statusWrap: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
    margin: "auto",
    position: "absolute",
    top: 0,
    right: 0,
  ...
  status: {
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Pending]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
      border: `1px solid ${theme.v1.palette.orange}`
    }),
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Connected]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
      border: `1px solid ${theme.colors.success.main}`
    }),
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Connecting]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
      border: `1px solid ${theme.v1.palette.brandWarning}`
    }),
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Disconnected]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
      border: `1px solid ${theme.colors.warning.main}`
    }),
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Shutdown]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
      border: `1px solid ${theme.colors.error.main}`
    }),
    [_grafana_data__WEBPACK_IMPORTED_MODULE_6__.LiveChannelConnectionState.Invalid]: (0,_emotion_css__WEBPACK_IMPORTED_MODULE_1__.css)({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LivePublish: () => (/* binding */ LivePublish)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./packages/grafana-data/src/types/live.ts");
...
/* harmony import */ var _grafana_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./packages/grafana-runtime/src/services/live.ts");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./public/app/plugins/panel/live/types.ts");
...
function LivePublish({ height, mode, body, addr, onSave }) {
  const txt = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    if (mode === _types__WEBPACK_IMPORTED_MODULE_8__.MessagePublishMode.JSON) {
  ...
  const onPublishClicked = async () => {
    if (mode === _types__WEBPACK_IMPORTED_MODULE_8__.MessagePublishMode.Influx) {
      if (addr?.scope !== "stream") {
        alert("expected stream scope!");
        return;
      }
      return (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__.getBackendSrv)().post(`api/live/push/${addr.namespace}`, body);
    }
    if (!(0,_grafana_data__WEBPACK_IMPORTED_MODULE_2__.isValidLiveChannelAddress)(addr)) {
      alert("invalid address");
      return;
    }
    const rsp = await (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__.getGrafanaLiveSrv)().publish(addr, body);
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
      ...
      {
        height: height - 32,
        language: mode === _types__WEBPACK_IMPORTED_MODULE_8__.MessagePublishMode.JSON ? "json" : "text",
        value: txt,
        onBlur: doSave,
        onSave: doSave,
        showMiniMap: false,
    ...
    /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { height: 32 }, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_ui__WEBPACK_IMPORTED_MODULE_7__.Button, { onClick: onPublishClicked, children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_grafana_i18n__WEBPACK_IMPORTED_MODULE_3__.Trans, { i18nKey: "live.live-publish.publish", children: "Publish" }) }) })
  ] });
}
...
/* harmony import */ var _LiveChannelEditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./public/app/plugins/panel/live/LiveChannelEditor.tsx");
/* harmony import */ var _LivePanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./public/app/plugins/panel/live/LivePanel.tsx");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./public/app/plugins/panel/live/types.ts");





const plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__.PanelPlugin(_LivePanel__WEBPACK_IMPORTED_MODULE_2__.LivePanel).setPanelOptions((builder) => {
  builder.addCustomEditor({
    category: ["Channel"],
    id: "channel",
    path: "channel",
    name: "Channel",
    editor: _LiveChannelEditor__WEBPACK_IMPORTED_MODULE_1__.LiveChannelEditor,
    defaultValue: {}
  });
  builder.addRadio({
    path: "display",
    ...
    settings: {
      options: [
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessageDisplayMode.Raw, label: "Raw Text" },
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessageDisplayMode.JSON, label: "JSON" },
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessageDisplayMode.Auto, label: "Auto" },
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessageDisplayMode.None, label: "None" }
      ]
    },
    defaultValue: _types__WEBPACK_IMPORTED_MODULE_3__.MessageDisplayMode.JSON
  }).addRadio({
    path: "publish",
    name: "Publish",
    ...
    settings: {
      options: [
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessagePublishMode.None, label: "None" },
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessagePublishMode.JSON, label: "JSON" },
        { value: _types__WEBPACK_IMPORTED_MODULE_3__.MessagePublishMode.Influx, label: "Influx" }
      ]
    },
    defaultValue: _types__WEBPACK_IMPORTED_MODULE_3__.MessagePublishMode.None
  });
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MessageDisplayMode: () => (/* binding */ MessageDisplayMode),
/* harmony export */   MessagePublishMode: () => (/* binding */ MessagePublishMode)
/* harmony export */ });

var MessageDisplayMode = /* @__PURE__ */ ((MessageDisplayMode2) => {
  MessageDisplayMode2["Raw"] = "raw";
  MessageDisplayMode2["JSON"] = "json";
  MessageDisplayMode2["Auto"] = "auto";
  MessageDisplayMode2["None"] = "none";
  return MessageDisplayMode2;
})(MessageDisplayMode || {});
var MessagePublishMode = /* @__PURE__ */ ((MessagePublishMode2) => {
  MessagePublishMode2["None"] = "none";
  MessagePublishMode2["JSON"] = "json";
  MessagePublishMode2["Influx"] = "influx";
  return MessagePublishMode2;
})(MessagePublishMode || {});
...
//# sourceMappingURL=livePanel.cc30d776b3a9f2f2adc2.js.map