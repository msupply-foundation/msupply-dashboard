...
export default class WorldmapCtrl extends MetricsPanelCtrl {
  ...
  outlineGeoJson: string;
  outlineGeoJsonColour: string;
  ...
  loadLocationDataFromFile(reload?) {
    ...
    if (this.panel.locationData === 'jsonp endpoint') {
      ...
      $.getJSON('public/plugins/grafana-worldmap-panel-msupply/data/' + this.panel.locationData + '.json').then(
  ...
  onInitEditMode() {
    this.addEditorTab('Worldmap', 'public/plugins/grafana-worldmap-panel-msupply/partials/editor.html', 2);
  }
  ...
  changeOutlineGeoJson() {
    this.renderGeoJsonLayer();
  }

  changeOutlineGeoJsonColour() {
    this.renderGeoJsonLayer();
  }
